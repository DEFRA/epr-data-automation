...
async def main():
    ...
    await dp_submit_registration_data_flow(config.env.PRODUCER_BASE_URL, email, "Password123", result.organisation_id, result.company_name, result.company_number)
